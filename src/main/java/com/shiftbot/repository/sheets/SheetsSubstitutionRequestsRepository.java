...
public class SheetsSubstitutionRequestsRepository implements SubstitutionRequestsRepository {
    private static final Logger log = LoggerFactory.getLogger(SheetsSubstitutionRequestsRepository.class);
    ...
    public SheetsSubstitutionRequestsRepository(SheetsClient sheetsClient) {
