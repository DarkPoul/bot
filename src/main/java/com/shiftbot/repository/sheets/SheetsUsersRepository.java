...
public class SheetsUsersRepository implements UsersRepository {
    private static final Logger log = LoggerFactory.getLogger(SheetsUsersRepository.class);
    ...
    public SheetsUsersRepository(SheetsClient sheetsClient, Duration cacheTtl) {
